...
exports.init = (app) => {
	...
	let viewDir = path.join(process.cwd(),`./${app.config.folder.app}/${app.config.folder.view}`);
...
// 模板设置
// app.use(koaViews(path.join(process.cwd(),`./${config.folder.app}/${config.folder.view}/`),{
//   map: {
...
//   let viewDir = path.join(process.cwd(),config.folder.view);
